...
<nav
    ...
    >
    <div class="container-shell min-h-[72px] flex items-center justify-between">
        <!-- Logo -->
        <a
            href="#hero"
            class="logo-mark font-mono text-sm font-bold tracking-widest"
            onclick={closeMenu}
            >
                ...
                <button
                    ...
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            {/if} < /svg> < /button> < /div> < /div>

                            <!-- Mobile Menu -->
                            {
                                #if menuOpen
                            } < div class = "md:hidden mobile-menu px-4 pb-4" >
                            <ul class="flex flex-col gap-2 py-3" role="list">
                                {#each links as link}
                                <li>
                                    <a
                                        href={link.href}
                                        class="mobile-nav-link block py-3 px-2 rounded-lg text-sm font-medium"
                                        onclick={closeMenu}
                                        >
                                        {link.label}
                                    </a>
